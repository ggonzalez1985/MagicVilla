...
namespace MagicVilla_Web.Services
{
	...
	{
		public readonly IHttpClientFactory _httpClient; //para hacer las conexiones
		private string _villaUrl;

        public UsuarioService(IHttpClientFactory httpClient, IConfiguration configuration) :base(httpClient)
        {
			_httpClient = httpClient;
			_villaUrl = configuration.GetValue<string>("ServiceUrls:API_URL"); //contiene la direccion de la API
		}
